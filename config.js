...
//
global.Owner = ["254716637803"];         //If you want singal number so global.Owner = ['8801928502256'] Change into your number.
...
global.mess = {
    ...
    banned: 'You are *Banned* fron using commands! now cry',
    bangc: 'This Group is *Banned* from using Commands!',
    nonsfw: 'Dont be an idiot This is not a NSFW enabled group!'
